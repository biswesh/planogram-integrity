...
int main(){
    ...
    Mat img_object = imread("/home/ubuntu/instanceMatch/test_data/scene_1.jpg", IMREAD_GRAYSCALE);
    resize(img_object,img_object,Size(),0.3,0.3,INTER_LINEAR);
    Mat img_scene = imread("/home/ubuntu/instanceMatch/test_data/scene_5.jpg", IMREAD_GRAYSCALE);
    resize(img_scene,img_scene,Size(),0.3,0.3,INTER_LINEAR);
    ...
    //    cout << "2 : " << matches[i].trainIdx << endl;
    ...
    //cout << "biswesh : " << good_matches.size() << endl;
